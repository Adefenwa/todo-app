        ...
        <main className="p-4">
          <div className="w-full lg:w-3/4  lg:flex lg:justify-between lg:items-center">
            <button
              ...
              className="bg-black hover:opacity-75 rounded-md px-5 py-2 text-white font-semibold text-sm transition delay-150 duration-300 ease-in-out hover:translate-y-0.5 hover:scale-110 hover:color"
            >
          ...
          <section className="bg-gray-50 w-full lg:w-3/4 my-5 p-3 rounded-md">
            ...
            <Link
              to={`/tasks/${task.id}`}
              className="bg-red-600 text-sm hover:bg-red-800 text-white px-3 mx-3 py-1 rounded-md"
            >
              Delete
            </Link>
          </section>
